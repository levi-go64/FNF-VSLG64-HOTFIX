...
local scale = 0.8
local ldim = 'jasminuretardedload' --put here your image name (the image must have a size of 1675 x 1083)
local loading = false

function onCreate()

    makeLuaSprite('ld', 'jasminuretardedload', -50, -100) -- creating the image
